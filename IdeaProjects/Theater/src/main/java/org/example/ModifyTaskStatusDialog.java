...
public class ModifyTaskStatusDialog extends GeneralPurposeDialog{

    private JTextField taskId, employeeId;
    private JLabel taskIdLabel, employeeIdLabel;

    public ModifyTaskStatusDialog(ProjectManager manager, Display owner) {
        super(manager, owner);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == okButton) {
            try{
                manager.modifyStatusOfTask(Integer.parseInt(employeeId.getText()), Integer.parseInt(taskId.getText()));
                dispose();
            }catch (Exception ex){
